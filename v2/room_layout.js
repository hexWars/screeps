...
let room_base = {
	run_1: function (room) {// 布局1
		...
		// ----------------------------------------------------------------------------1
		room.keep_creep_num(0/*1*/, "defender",
			"no", "E55N12",
			"no", "no",
	...
	run_2: function (room) {
		...
		room.keep_creep_num(1, "harvester_x",
			"5bbcb705d867df5e54207ca1", room.name,// 化合物
			"6225b4f3039a6e0168a883da", room.name,
			"Spawn2", [WORK, WORK, WORK, WORK, WORK, WORK, WORK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY, CARRY])
		...
		room.keep_creep_num(1/*2*/, "upgrader",
		...
		room.keep_creep_num(1, "builder",
			"621c39dfae65a2ba81ee5dfb", room.name,// 本地storage
	...
	run_3: function (room) {
		...
		room.keep_creep_num(6, "occupier",
			"5bbcb09e9099fc012e63c703", "E59N12",
			"5bbcb09e9099fc012e63c701", "E59N12",
			"Spawn2", [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, WORK, WORK, CARRY, CARRY])

		// room.keep_creep_num(6, "occupier",
		// 	"5bbcb09e9099fc012e63c703", "E59N12",
		// 	"5bbcb09e9099fc012e63c701", "E59N12",
		// 	"Spawn3", [MOVE, MOVE, CARRY, WORK])


	},
	run_E59S53: function (room) {// 布局1
		prototype()
		// 塔
		// tower.run_1(Game.getObjectById("620d4e8351da53fd9193b024"))
		// tower.run_1(Game.getObjectById("62131c91803a815756709de8"))
		// creep
		room.keep_creep_num(7, "occupier",
			"no", "E19S53",
			"no", "E19S53",
			"Spawn1", [MOVE, MOVE, WORK, CARRY])
		// room.keep_creep_num(2, "occupier",
		// 	"no", "E19S53",
		// 	"no", "E19S53",
		// 	"Spawn1", [MOVE, MOVE, WORK, CARRY])
